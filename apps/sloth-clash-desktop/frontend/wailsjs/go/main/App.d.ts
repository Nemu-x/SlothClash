...
export function CompanionDiscover(): Promise<Array<companion.AgentInfo>>

export function CompanionListAgents(): Promise<Array<companion.AgentInfo>>

export function CompanionPairByPin(
  arg1: string,
  arg2: string,
): Promise<companion.AgentInfo>

export function CompanionPairByString(
  arg1: string,
): Promise<companion.AgentInfo>

export function CompanionPower(
  arg1: string,
  arg2: string,
): Promise<companion.PowerResult>

export function CompanionRename(arg1: string, arg2: string): Promise<void>

export function CompanionShareSubscription(arg1: string): Promise<void>

export function CompanionStartDiscovery(): Promise<void>

export function CompanionStatus(arg1: string): Promise<companion.StatusView>

export function CompanionStopDiscovery(): Promise<void>
...
export function DeriveAgePublicKey(arg1: string): Promise<string>
...
export function RefreshSlothServiceStatus(): Promise<main.ServiceState>
...
export function SetProfileAgeSecretKey(
  arg1: string,
  arg2: string,
): Promise<main.AppState>
