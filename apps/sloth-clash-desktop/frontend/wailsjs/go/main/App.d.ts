...
export function GetProfileProxyGroupsBaseline(arg1:string):Promise<main.ProfileProxyGroupsBaseline>;

export function GetProfileRulesBaseline(arg1:string):Promise<main.ProfileRulesBaseline>;
...
export function ImportProfileFromURL(arg1:string,arg2:string):Promise<main.AppState>;
...
export function PeekSubscriptionFromURL(arg1:string):Promise<main.SubscriptionPeek>;
...
export function SetProfileAutoUpdate(arg1:string,arg2:boolean,arg3:number):Promise<main.AppState>;

export function SetProfileMergeTemplate(arg1:string,arg2:string):Promise<main.AppState>;

export function SetProfileProxyTemplate(arg1:string,arg2:string):Promise<main.AppState>;

export function SetProfileRulesTemplate(arg1:string,arg2:string):Promise<main.AppState>;
...
export function SetTrafficSettings(arg1:main.TrafficSettings):Promise<main.DesktopPrefs>;

export function SetTunSettings(arg1:main.TunSettings):Promise<main.DesktopPrefs>;

export function SetUpdateChannel(arg1:string):Promise<main.UpdateState>;

export function StartedMinimized():Promise<boolean>;

export function UpdateProfileInfo(arg1:string,arg2:string,arg3:string):Promise<main.AppState>;

export function WriteProfileConfig(arg1:string,arg2:string):Promise<main.AppState>;
